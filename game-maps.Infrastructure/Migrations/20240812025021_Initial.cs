        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapConfig_StartLat = table.Column<decimal>(type: "numeric", nullable: false),
                    MapConfig_StartLng = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Group = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false, defaultValue: "other"),
                    Title = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    Icon = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Info = table.Column<string>(type: "character varying(900)", maxLength: 900, nullable: true),
                    Template = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    Order = table.Column<int>(type: "integer", nullable: true, defaultValue: 1),
                    HasHeatmap = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    FeaturesEnabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DisplayType = table.Column<string>(type: "text", nullable: false, defaultValue: "marker"),
                    IgnEnabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    IgnVisible = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
